...
define <vscale x 4 x i32> @svmul_m_ptrue_i32_by_5(<vscale x 4 x i32> %x) {
; CHECK-LABEL: svmul_m_ptrue_i32_by_5:
; CHECK:       // %bb.0:
; CHECK-NEXT:    adr z0.s, [z0.s, z0.s, lsl #2]
; CHECK-NEXT:    ret
  %out = call <vscale x 4 x i32> @llvm.aarch64.sve.mul.nxv4i32(
...
define <vscale x 4 x i32> @svmla_m_ptrue_i32_by_2(<vscale x 4 x i32> %a,
                                                  <vscale x 4 x i32> %x) {
; CHECK-LABEL: svmla_m_ptrue_i32_by_2:
; CHECK:       // %bb.0:
; CHECK-NEXT:    adr z0.s, [z0.s, z1.s, lsl #1]
; CHECK-NEXT:    ret
...
define <vscale x 4 x i32> @svmla_m_ptrue_i32_by_8_commuted(
    <vscale x 4 x i32> %a, <vscale x 4 x i32> %x) {
; CHECK-LABEL: svmla_m_ptrue_i32_by_8_commuted:
; CHECK:       // %bb.0:
; CHECK-NEXT:    adr z0.s, [z0.s, z1.s, lsl #3]
; CHECK-NEXT:    ret
  %out = call <vscale x 4 x i32> @llvm.aarch64.sve.mla.nxv4i32(
